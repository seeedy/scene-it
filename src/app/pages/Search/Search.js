      ...
      <div id='outer-wrapper'>
          ...
          <div id='preview'>
            ...
            <div id='scene-modal-menu'>
              <div className='preview-buttons-box'>
                <button className='scene-btn' onClick={this.chooseScene}>
                  <i className='fas fa-check-circle'></i>
                </button>
                <div id='choose-scene'>Choose this scene?</div>
                <button className='scene-btn' onClick={this.closeModal}>
        ...
        <div id='search-wrapper'>
          <div id='search-bar'>
            ...
            />
            <button id='search-btn' onClick={this.getScenes}>
